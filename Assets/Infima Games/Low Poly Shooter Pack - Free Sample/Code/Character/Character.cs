...
namespace InfimaGames.LowPolyShooterPack
{
	...
	public sealed class Character : CharacterBehaviour
	{
        ...
        /// </summary>
        private bool holstered;		/// <summary>
        ...
        /// <summary>
        /// True if the player pressed the jump button.
        /// </summary>
        private bool pressedButtonJump;
        /// <summary>
        /// True if the player is holding the crouch button.
        /// </summary>
        private bool holdingButtonCrouch;		/// <summary>
        ...
        protected override void Update()
        {
            ...
            //Match Crouch.
            crouching = holdingButtonCrouch;
            //Match Jump (single frame flag).
            jumping = pressedButtonJump;
            //Reset jump flag after this frame.
            pressedButtonJump = false;
		...
		public void OnTryJump(InputAction.CallbackContext context)
		{
			...
			switch (context.phase)
			{
				//Performed.
				case InputActionPhase.Performed:
					//Set jump flag for this frame.
					pressedButtonJump = true;
					break;
			}
		}
		/// <summary>
